...
rng(604); % set seed to ensure replicability
...
title('Case 4: Distribution of ρ(est) − 1');
xlabel('i', 'Fontsize', 14);
ylabel('y', 'Fontsize', 14);
set(gca, 'Fontsize', 12);
...
title('Case 4: Distribution of sqrt(T) * ρ(est) − 1');
xlabel('i', 'Fontsize', 14);
ylabel('y', 'Fontsize', 14);
set(gca, 'Fontsize', 12);
...
title('Case 4: Distribution of T * ρ(est) − 1');
xlabel('i', 'Fontsize', 14);
ylabel('y', 'Fontsize', 14);
set(gca, 'Fontsize', 12);
...
title('Case 4: Distribution of t-statistic');
xlabel('i', 'Fontsize', 14);
ylabel('y', 'Fontsize', 14);
set(gca, 'Fontsize', 12);
